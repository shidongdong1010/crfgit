...
<%@ include file="/common/config.jsp"%>
	...
	<script type="text/javascript">
			var _menus = {"menus":[
				{"menuid":"1","icon":"icon-sys","menuname":"系统管理",
					...
					"menus":[{"menuname":"员工列表","icon":"icon-nav","url":"${ctx}/emp/emp-list-init.do"},
							{"menuname":"城市列表","icon":"icon-nav","url":"${ctx}/org/org-list-init.do"}
						]
				...
				},{"menuid":"28","icon":"icon-sys","menuname":"流程管理",
					"menus":[{"menuname":"流程定义及部署","icon":"icon-nav","url":"${ctx}/workflow/process-list-init.do"},
	...
	<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
	    ...
	    <div id="w" class="easyui-window" title="修改密码" collapsible="false" minimizable="false"
	        maximizable="false" icon="icon-save"  style="width: 300px; height: 170px; padding: 5px;
	        background: #fafafa;">
